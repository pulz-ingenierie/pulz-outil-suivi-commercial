...
function IcTableau() { return <svg {...I}><rect x="3" y="3" width="7" height="9" rx="1.5" /><rect x="14" y="3" width="7" height="5" rx="1.5" /><rect x="14" y="12" width="7" height="9" rx="1.5" /><rect x="3" y="16" width="7" height="5" rx="1.5" /></svg>; }
...
export default function BottomNav() {
  ...
  return (
    <nav className="bottom-nav" aria-label="Navigation principale">
      <Link className={`bn-item${on("/tableau") ? " on" : ""}`} href="/tableau"><IcTableau /><span>Tableau</span></Link>
